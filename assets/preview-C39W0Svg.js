...
`;class P extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).appendChild(p.content.cloneNode(!0))}}customElements.define(I,P);const D="fn-action",v=document.createElement("template");v.innerHTML=`
  <style>
    ::slotted(a),
    ::slotted(button) {
...
`;class V extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}).appendChild(f.content.cloneNode(!0))}}customElements.define(_,V);const B="fn-image",w=document.createElement("template");w.innerHTML=`
  <style>
    :host {
      --corner: 1rem;
